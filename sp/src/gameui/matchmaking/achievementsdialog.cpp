...
CAchievementsDialog_XBox::CAchievementsDialog_XBox( vgui::Panel *pParent ) : BaseClass( pParent, "AchievementsDialog" )
{
	...
	m_pProgressBg = new vgui::Panel(this, "ProgressBgCenter");
...
void CAchievementsDialog_XBox::PerformLayout( void )
{
	...
	//480p
#ifdef _X360UI480p
		int x, y, wide = 160, tall = 16;
		m_pProgressBg->SetBounds(280 - ((wide) / 2)+10, 307, wide, tall);
		m_pProgressBar->SetBounds(280 - ((wide) / 2)+10, 307, wide, tall);
#endif

	//720p
#ifdef _X360UI720p
		int x, y, wide = 260, tall = 18;
		m_pProgressBg->SetBounds(390 - ((wide) / 2), 395, wide, tall);
		m_pProgressBar->SetBounds(390 - ((wide) / 2), 395, wide, tall);
#endif

	//1080p
#ifdef _X360UI1080p
		int x, y, wide = 394, tall = 28;
		m_pProgressBg->SetBounds( 573 - ((wide) / 2), 545, wide, tall );
		m_pProgressBar->SetBounds( 573 - ( ( wide) / 2), 545, wide, tall );
#endif

	//1440p
#ifdef _X360UI1440p
		int x, y, wide = 520, tall = 36;
		m_pProgressBg->SetBounds(780 - ((wide) / 2),790, wide, tall);
		m_pProgressBar->SetBounds(780 - ((wide) / 2), 790, wide, tall);
#endif

	//2160p
#ifdef _X360UI2160p
		int x, y, wide = 788, tall = 56;
		m_pProgressBg->SetBounds(1146 - ((wide) / 2), 1090, wide, tall );
		m_pProgressBar->SetBounds(1146 - ((wide) / 2), 1090, wide, tall );
#endif
	...
	//480p
#ifdef _X360UI480p
		m_pProgressPercent->SetPos( 178, 307 );
		m_pProgressPercent->SetWide( 160 );
#endif

	//720p
#ifdef _X360UI720p
		m_pProgressPercent->SetPos( 198, 392 );
		m_pProgressPercent->SetWide( 260 );
#endif

	//1080p
#ifdef _X360UI1080p
		m_pProgressPercent->SetPos( 14, 542 );
		m_pProgressPercent->SetWide( 1118 );
#endif

	//1440p
#ifdef _X360UI1440p
		m_pProgressPercent->SetPos( 396, 784 );
		m_pProgressPercent->SetWide( 520 );
#endif

	//2160p
#ifdef _X360UI2160p
		m_pProgressPercent->SetPos( 28, 1084 );
		m_pProgressPercent->SetWide( 2236 );
#endif
	...
	//480p
#ifdef _X360UI480p
		int iBottomOfTable = menuy + m_Menu.GetTall() + 12;
#endif

	//720p
#ifdef _X360UI720p
		int iBottomOfTable = menuy + m_Menu.GetTall() + 7;
#endif
	...
	//1440p
#ifdef _X360UI1440p
		int iBottomOfTable = menuy + m_Menu.GetTall() + 14;
#endif

	//2160p
#ifdef _X360UI2160p
		int iBottomOfTable = menuy + m_Menu.GetTall() + 6;
#endif
	...
	//480p
#ifdef _X360UI480p
		m_pNumbering->SetPos( 20, iBottomOfTable + 2 );
#endif

	//720p
#ifdef _X360UI720p
		m_pNumbering->SetPos( 30, iBottomOfTable);
#endif

	//1080p
#ifdef _X360UI1080p
		m_pNumbering->SetPos( 45, iBottomOfTable + 5);
#endif

	//1440p
#ifdef _X360UI1440p
		m_pNumbering->SetPos( 60, iBottomOfTable + 3);
#endif

	//2160p
#ifdef _X360UI2160p
		m_pNumbering->SetPos( 90, iBottomOfTable + 10);
#endif
	...
	//1080p
#ifdef _X360UI1080p
		m_pUpArrow->SetPos( x, iBottomOfTable + 6 );
#else
	//ELSE
	...
	//1080p
#ifdef _X360UI1080p
		m_pDownArrow->SetPos( x, iBottomOfTable + 7 );
#else
	//ELSE
...
void CAchievementsDialog_XBox::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	Color m_SelColor = pScheme->GetColor("Orange", Color(255, 115, 0, 96));

	m_pProgressBg->SetBgColor( Color( 0, 0, 0, 128 ) );
	m_pProgressBar->SetBgColor(  Color( m_SelColor[0], m_SelColor[1], m_SelColor[2], 96 ) );
 	m_pProgressPercent->SetFgColor( pScheme->GetColor( "MatchmakingMenuItemDescriptionColor", Color( 64, 64, 64, 128 ) ) );
 	m_pNumbering->SetFgColor( pScheme->GetColor( "MatchmakingMenuItemDescriptionColor", Color( 64, 64, 64, 128 ) ) );
}
...
void CAchievementsDialog_XBox::OnKeyCodePressed( vgui::KeyCode code )
{
	...
	if (code == KEY_XBUTTON_B || code == KEY_BACKSPACE )
	{
...
//480p
#ifdef _X360UI480p
	m_iFixedWidth = pResourceData->GetInt("wide", 550);
#endif

//720p
#ifdef _X360UI720p
	m_iFixedWidth = pResourceData->GetInt("wide", 780);
#endif

//1080p
#ifdef _X360UI1080p
	m_iFixedWidth = pResourceData->GetInt("wide", 1122);
#endif

//1440p
#ifdef _X360UI1440p
	m_iFixedWidth = pResourceData->GetInt("wide", 1560);
#endif

//2160p
#ifdef _X360UI2160p
	m_iFixedWidth = pResourceData->GetInt("wide", 2244);
#endif
...
//480p
#ifdef _X360UI480p
	m_pPercentageBar->SetWide( 160 * flCompletion );
#endif

//720p
#ifdef _X360UI720p
	m_pPercentageBar->SetWide( 260 * flCompletion );
#endif

//1080p
#ifdef _X360UI1080p
	m_pPercentageBar->SetWide( 394 * flCompletion );
#endif

//1440p
#ifdef _X360UI1440p
	m_pPercentageBar->SetWide( 520 * flCompletion );
#endif

//2160p
#ifdef _X360UI2160p
	m_pPercentageBar->SetWide( 788 * flCompletion );
#endif
