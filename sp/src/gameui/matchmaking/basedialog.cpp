...
void CBaseDialog::PaintBackground()
{
...
//480p/720p
	...
	int yWin = 35;
	vgui::surface()->DrawFilledRect(8, yWin, wide - 8, tall - yWin);
#endif

//1080p
#ifdef _X360UI1080p
	int yWin = 54;
	vgui::surface()->DrawFilledRect(12, yWin, wide - 12, tall - yWin);
#endif

//1440p
#ifdef _X360UI1440p
	int yWin = 70;
	vgui::surface()->DrawFilledRect(16, yWin, wide - 16, tall - yWin);
#endif

//2160p
#ifdef _X360UI2160p
	int yWin = 108;
	vgui::surface()->DrawFilledRect(24, yWin, wide - 24, tall - yWin);
#endif
...
void CBaseDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_pTitle->SetFgColor( pScheme->GetColor( "MatchmakingDialogTitleColor", Color( 200, 200, 200, 255 ) ) );
...
void CScenarioInfoPanel::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	Color fontColor = pScheme->GetColor( "MatchmakingDialogTitleColor", Color( 200, 200, 200, 255 ) );
