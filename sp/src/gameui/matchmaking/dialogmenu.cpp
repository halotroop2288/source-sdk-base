...
//480p
#ifdef _X360UI480p
	m_pTitle->SetWide( 300 );
#endif

//720p
#ifdef _X360UI720p
	m_pTitle->SetWide( 322 );
#endif

//1080p
#ifdef _X360UI1080p
	m_pTitle->SetWide( 470 );
#endif

//1440p
#ifdef _X360UI1440p
	m_pTitle->SetWide( 644 );
#endif

//2160p
#ifdef _X360UI2160p
	m_pTitle->SetWide( 940 );
#endif
	...
	//480p
#ifdef _X360UI480p
		m_pDescription->SetWide( 450 );
#endif

	//720p
#ifdef _X360UI720p
		m_pDescription->SetWide( 324 );
#endif

	//1080p
#ifdef _X360UI1080p
		m_pDescription->SetWide( 470 );
#endif

	//1440p
#ifdef _X360UI1440p
		m_pDescription->SetWide( 648 );
#endif

	//2160p
#ifdef _X360UI2160p
		m_pDescription->SetWide( 940 );
#endif
...
void CMenuItem::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_BgColor			= pScheme->GetColor( "MatchmakingMenuItemBackground", Color( 64, 64, 64, 0 ) );
	m_BgColorActive		= pScheme->GetColor( "MatchmakingMenuItemBackgroundActive", Color( m_SelColor[0], m_SelColor[1], m_SelColor[2], 128 ) );
...
{
	vgui::HScheme scheme = vgui::scheme()->GetScheme("SourceScheme");

	Color ActCol = GetSchemeColor( "Orange", Color(255, 115, 0, 96), vgui::scheme()->GetIScheme(scheme) );

	if ( bActive )
	{
		ActiveColor = Color( ActCol[0], ActCol[1], ActCol[2], 96 );
		ActiveColor2 = Color( 0, 0, 0, 96 );
	}
	else
	{
		ActiveColor = Color( 0, 0, 0, 0 );
		ActiveColor2 = Color( 0, 0, 0, 0 );
	}
}
...
// Set an item as having input focus
//-----------------------------------------------------------------------
void CMenuItem::PaintBackground( )
{
...
//480p
#ifdef _X360UI480p
	DrawBoxFade( 0, 0, 528, 48, ActiveColor, 1.0f, 255, 0, true );
	DrawBoxFade( 2, 2, 524, 44, ActiveColor2, 1.0f, 255, 0, true );
#endif

//720p
#ifdef _X360UI720p
	DrawBoxFade(0, 0, 748, 48, ActiveColor, 1.0f, 255, 0, true );
	DrawBoxFade(2, 2, 744, 44, ActiveColor2, 1.0f, 255, 0, true );
#endif

//1080p
#ifdef _X360UI1080p
	DrawBoxFade(0, 0, 1108, 64, ActiveColor, 1.0f, 255, 0, true );
	DrawBoxFade(3, 3, 1102, 58, ActiveColor2, 1.0f, 255, 0, true );
#endif

//1440p
#ifdef _X360UI1440p
	DrawBoxFade(0, 0, 1496, 96, ActiveColor, 1.0f, 255, 0, true );
	DrawBoxFade(4, 4, 1488, 88, ActiveColor2, 1.0f, 255, 0, true );
#endif

//2160p
#ifdef _X360UI2160p
	DrawBoxFade(0, 0, 2216, 128, ActiveColor, 1.0f, 255, 0, true );
	DrawBoxFade(6, 6, 2204, 116, ActiveColor2, 1.0f, 255, 0, true );
#endif
...
void COptionsItem::PerformLayout()
{
	...
	{
		m_pLeftArrow->SetAlpha( 64 );
	}
	else if ( m_nActiveOption == m_OptionLabels.Count() - 1 )
	{
		m_pRightArrow->SetAlpha( 64 );
	}
}
...
void COptionsItem::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_pTitle->SetFgColor( pScheme->GetColor( "MatchmakingMenuItemTitleColor", Color( 200, 200, 200, 255 ) ) );
...
void COptionsItem::AddOption( const char *pLabelText, const sessionProperty_t& option )
{
	...
	pOption->SetBgColor( Color( 64, 64, 64, 225 ) );
	pOption->SetFgColor( m_pTitle ? m_pTitle->GetFgColor() : Color( 200, 200, 200, 255 ) );
...
void CAchievementItem::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_pPoints->SetFgColor( Color( 64, 64, 64, 0 ) );
...
void CSectionedItem::AddSection( const char *pText, int align )
{
	...
	sec.pLabel->SetBgColor( Color( 191, 116, 0, 128 ) );
...
void CDialogMenu::ApplySettings( KeyValues *pResourceData )
{
	...
	if ( pColumnData )
	{
		...
		Color headerColor = m_pScheme->GetColor( pColumnData->GetString( "headerfgcolor" ), Color( 0, 0, 0, 0 ) );
		for ( int i = 0; i < idx; ++i )
		{
