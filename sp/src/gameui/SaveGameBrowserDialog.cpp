...
//480p
#ifdef _X360UI480p
	#define TGA_IMAGE_PANEL_WIDTH 107
	#define TGA_IMAGE_PANEL_HEIGHT 61
#endif

//720p
#ifdef _X360UI720p
	#define TGA_IMAGE_PANEL_WIDTH 152
	#define TGA_IMAGE_PANEL_HEIGHT 86
#endif

//1080p
#ifdef _X360UI1080p
	#define TGA_IMAGE_PANEL_WIDTH 228
	#define TGA_IMAGE_PANEL_HEIGHT 129
#endif

//1440p
#ifdef _X360UI1440p
	#define TGA_IMAGE_PANEL_WIDTH 304
	#define TGA_IMAGE_PANEL_HEIGHT 172
#endif

//2160p
#ifdef _X360UI2160p
	#define TGA_IMAGE_PANEL_WIDTH 456
	#define TGA_IMAGE_PANEL_HEIGHT 258
#endif
...
: BaseClass( parent, "SaveGamePanel" )
{
	...
	m_pLevelPicTGA = SETUP_PANEL( new CTGAImagePanel( this, "LevelPicTGA" ) );
	...
	if ( pchChapterName )
	{
		...
		char tga[_MAX_PATH];
		Q_strncpy( tga, m_SaveInfo.szFileName, sizeof(tga ) );
	...
	{
		m_pLevelPic->SetImage( "resource/autosave" );
	}
...
{
	m_TextColor = pScheme->GetColor( "OptSelectedTextColor", Color(255, 255, 255, 255) );
	...
	m_pType->SetFgColor( m_TextColor );
...
void CSaveGameBrowserDialog::LayoutPanels( void )
{
	...
	//1080p
#ifdef _X360UI1080p
		int panelWidth = m_SavePanels[0]->GetWide() + 24;
		int dialogWidth = GetWide();
	...
	//1440p
#ifdef _X360UI1440p
		int panelWidth = m_SavePanels[0]->GetWide() + 32;
		int dialogWidth = GetWide();
	...
	//2160p
#ifdef _X360UI2160p
		int panelWidth = m_SavePanels[0]->GetWide() + 48;
		int dialogWidth = GetWide();
	...
	//1080p
#ifdef _X360UI1080p
		m_pCenterBg->SetWide( panelWidth + 24 );
	...
	//2160p
#ifdef _X360UI2160p
		m_pCenterBg->SetWide( panelWidth + 48 );
...
void CSaveGameBrowserDialog::AnimateDialogStart( void )
{
	...
	if (selectedPanel && ( selectedPanel->IsAutoSaveType() || selectedPanel->IsQuickSaveType() ) )
	{
		//STAVAAS Res
	
	//480p
#ifdef _X360UI480p
		m_pCenterBg->SetTall( m_nCenterBgTallDefault + 14 );
#endif
	...
	//1080p
#ifdef _X360UI1080p
		m_pCenterBg->SetTall( m_nCenterBgTallDefault + 30 );
#endif

	//1440p
#ifdef _X360UI1440p
		m_pCenterBg->SetTall( m_nCenterBgTallDefault + 40 );
#endif

	//2160p
#ifdef _X360UI2160p
		m_pCenterBg->SetTall( m_nCenterBgTallDefault + 60 );
#endif
...
//1080p
#ifdef _X360UI1080p
	vgui::surface()->DrawFilledRect(12, y, wide - 12, tall - 12);
#endif

//1440p
#ifdef _X360UI1440p
	vgui::surface()->DrawFilledRect(16, y, wide - 16, tall - 16);
#endif

//2160p
#ifdef _X360UI2160p
	vgui::surface()->DrawFilledRect( 24, y, wide - 24, tall - 24 );
#endif
