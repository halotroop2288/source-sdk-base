...
ConVar x360_resolution_width( "x360_resolution_width", "1920", 0, "This is only used for reference. Changing this value does nothing" );
ConVar x360_resolution_height( "x360_resolution_height", "1080", 0, "This is only used for reference. Changing this value does nothing" );
...
COptionsDialogXbox::COptionsDialogXbox( vgui::Panel *parent, bool bControllerOptions ) : BaseClass( parent, "OptionsDialog" )
{
	...
	//480p/720p
		...
		m_pValueBars[ iLabel ]->SetSegmentInfo( 2, 6 );
#endif

	//1080p
#ifdef _X360UI1080p
		m_pValueBars[ iLabel ]->SetSegmentInfo( 3, 9 );
#endif

	//1440p
#ifdef _X360UI1440p
		m_pValueBars[ iLabel ]->SetSegmentInfo( 4, 12 );
#endif

	//2160p
#ifdef _X360UI2160p
		m_pValueBars[ iLabel ]->SetSegmentInfo( 6, 18 );
#endif
	...
	m_KeyRepeat.SetKeyRepeatTime( KEY_LEFT, 0.08 );
	m_KeyRepeat.SetKeyRepeatTime( KEY_RIGHT, 0.08 );
}
...
void COptionsDialogXbox::PaintBackground()
{
...
//1080p
#ifdef _X360UI1080p
	m_iNumItems = ( iTall - 108 ) / m_iOptionSpacing;
#endif

//1440p
#ifdef _X360UI1440p
	m_iNumItems = ( iTall - 140 ) / m_iOptionSpacing;
#endif

//2160p
#ifdef _X360UI2160p
	m_iNumItems = ( iTall - 216 ) / m_iOptionSpacing;
#endif
	...
	//1080p
#ifdef _X360UI1080p
		iTall = m_iNumItems * m_iOptionSpacing + 108;
#endif

	//1440p
#ifdef _X360UI1440p
		iTall = m_iNumItems * m_iOptionSpacing + 140;
#endif

	//2160p
#ifdef _X360UI2160p
		iTall = m_iNumItems * m_iOptionSpacing + 216;
#endif
...
//1080p
#ifdef _X360UI1080p
	pPanel->SetTall( iTall - 108 );
#endif

//1440p
#ifdef _X360UI1440p
	pPanel->SetTall( iTall - 140 );
#endif

//2160p
#ifdef _X360UI2160p
	pPanel->SetTall( iTall - 216 );
#endif
...
//480p/720p
#if defined(_X360UI480p) || defined(_X360UI720p)
	m_pOptionsUpArrow->SetPos( iX, iTall - 33 );
#endif

//1080p
#ifdef _X360UI1080p
	m_pOptionsUpArrow->SetPos( iX, iTall - 51 );
#endif

//1440p
#ifdef _X360UI1440p
	m_pOptionsUpArrow->SetPos( iX, iTall - 66 );
#endif

//2160p
#ifdef _X360UI2160p
	m_pOptionsUpArrow->SetPos( iX, iTall - 102 );
#endif
...
//480p/720p
#if defined(_X360UI480p) || defined(_X360UI720p)
	m_pOptionsDownArrow->SetPos( iX, iTall - 33 );
#endif

//1080p
#ifdef _X360UI1080p
	m_pOptionsDownArrow->SetPos( iX, iTall - 50 );
#endif

//1440p
#ifdef _X360UI1440p
	m_pOptionsDownArrow->SetPos( iX, iTall - 64 );
#endif

//2160p
#ifdef _X360UI2160p
	m_pOptionsDownArrow->SetPos( iX, iTall - 100 );
#endif
...
void COptionsDialogXbox::HandleBindKeyCodePressed( vgui::KeyCode code )
{
	...
	if ( code == KEY_XBUTTON_START || code == KEY_BACKSPACE )
	{
		vgui::surface()->PlaySound( "UI/buttonrollover.wav" );
		UpdateBind( m_pSelectedOption, GetSelectionLabel() );
	}
	else
...
void COptionsDialogXbox::ActivateSelection( void )
{
	...
	m_ActColor = GetSchemeColor( "OptSelectedTextColor", Color(255, 255, 255, 255), vgui::scheme()->GetIScheme( scheme ) );

	int iLabel = GetSelectionLabel();

	m_pOptionLabels[ iLabel ]->SetFgColor( m_ActColor );

	m_pValueLabels[iLabel]->SetFgColor(m_ActColor);
...
//1080p
#ifdef _X360UI1080p
	m_pOptionsSelectionLeft2->SetPos(iX, iYPos + 3 );
#endif

//1440p
#ifdef _X360UI1440p
	m_pOptionsSelectionLeft2->SetPos(iX, iYPos + 4 );
#endif

//2160p
#ifdef _X360UI2160p
	m_pOptionsSelectionLeft2->SetPos(iX, iYPos + 6 );
#endif
...
void COptionsDialogXbox::FillInDefaultBindings( void )
{
	...
	for ( int iLabel = 0; iLabel < m_iNumItems; ++iLabel )
	{
		...
		engine->ClientCmd("joy_pitchsensitivity 1.5");
		engine->ClientCmd("joy_pitchsensitivity_default 1.5");
	}
}
