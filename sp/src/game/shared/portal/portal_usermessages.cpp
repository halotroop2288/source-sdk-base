...
void RegisterUserMessages()
{
	...
	usermessages->Register("HapDmg", 4);
	usermessages->Register("HapPunch", 4);
	usermessages->Register("HapSetDrag", 4);
	usermessages->Register("HapSetConst", 4);
	usermessages->Register("HapMeleeContact", 4);
